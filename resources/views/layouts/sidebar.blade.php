        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @elseif (Auth::user()->level_id == 2)
                    <!-- Dosen/Tendik Menu -->
                    <li class="nav-item">
                        <a href="{{ url('/dashboardDos') }}" class="nav-link {{ $activeMenu == 'dashboardDos' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                ...
                @elseif (Auth::user()->level_id == 3)
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/riwayatMhs') }}" class="nav-link {{ $activeMenu == 'riwayatMhs' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-history"></i>
                ...
                @elseif (Auth::user()->level_id == 4)
                    <!-- Kaprodi Menu -->
                    <li class="nav-item">
                        <a href="{{ url('/dashboardKap') }}" class="nav-link {{ $activeMenu == 'dashboardKap' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/riwayatPenerimaan') }}" class="nav-link {{ $activeMenu == 'riwayatPen' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-history"></i>
