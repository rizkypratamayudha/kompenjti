        ...
        <div class="card shadow-sm border-0 rounded-lg">
            <div class="card-header bg-warning text-white d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0">
                    <i class="bi bi-pie-chart-fill me-3 mr-3 ml-3"></i>Statistik Kompen & Level Pengguna
                </h4>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4 d-flex justify-content-center">
                        <div class="py-3">
                            <canvas id="levelPieChart" style="width: 400px; height: 400px; max-width: 100%;"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4 d-flex justify-content-center">
                        <div class="py-3">
                            <canvas id="kompenPieChart" style="width: 400px; height: 400px; max-width: 100%;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    new Chart(ctxLevel, {
        type: 'pie',
        data: {
            labels: chartData.labels, // Use the labels from the controller
            datasets: [{
                data: chartData.data, // Use the data from the controller
                backgroundColor: ['#2196f3', '#4caf50', '#ff9800', '#9e9e9e', '#f44336', '#8bc34a'], // Custom colors
                hoverBackgroundColor: ['#64b5f6', '#66bb6a', '#ffb74d', '#cfd8dc', '#ef9a9a', '#c5e1a5']
            }]
        },
        options: {
