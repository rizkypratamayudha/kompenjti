...
label="Close"><span aria-hidden="true">&times;</span></button> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <a href="{{ asset('template_level.xlsx') }}" class="btn btn-info btn
sm" download><i class="fa fa-file-excel"></i> Download</a> 
                    <small id="error-kode_level" class="error-text form-text text
danger"></small> 
                </div> 
                <div class="form-group"> 
                    <label>Pilih File</label> 
                    <input type="file" name="file_level" id="file_level" class="form
control" required> 
                    <small id="error-file_level" class="error-text form-text text
danger"></small> 
                </div> 
            </div> 
