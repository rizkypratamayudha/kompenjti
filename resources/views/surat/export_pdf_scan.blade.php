...
<body>
    ...
    <div class="text-center">
        <p>
            Surat ini telah disetujui oleh dosen dari pekerjaan terkait dan juga Kaprodi<br><br>
            Nama : {{$penerimaan->user->nama}}<br>
            NIM : {{$penerimaan->user->username}}<br>
            Prodi : {{ $penerimaan->user->detailMahasiswa->prodi->prodi_nama}}
        </p>
    </div>
</body>
