...
<head>
    ...
    <style>
        ...
        .notification { background-color: #28a745; color: #ffffff; padding: 10px; text-align: center; border-radius: 5px; margin-top: 10px; font-size: 12px; }
...
<body>
    <div class="container">
        ...
        <div class="notification">
            Selamat! Kami dengan senang hati menginformasikan bahwa registrasi Anda pada Aplikasi Kompensasi Politeknik Negeri Malang telah berhasil dan disetujui.
        </div>
        ...
        <!-- Button Section -->
        <div class="button">
            <a href="https://yourapplication.com/login" target="_blank">Kunjungi</a>
        </div>
